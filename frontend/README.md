...
1. **Dashboard** — network topology, agent message-flow & coalition overlay, live alert
   feed, live performance metrics vs. SRS targets, resource-allocation panel.
...
3. **Validator** — deterministic replay with the constraint checker asserting every SRS
   functional requirement, validation summary, and selected incident chain.
